...
training_args = TrainingArguments(
    output_dir="models/philberta-archaic",
    ...
    logging_dir='./logs/philberta',
    run_name="philberta-iphi-archaic",
)
...
trainer.train()
trainer.save_model('models/philberta-archaic')
tokenizer.save_pretrained('models/philberta-archaic')
