...
training_args = TrainingArguments(
    output_dir="models/logion-iphi-archaic",
...
trainer.train()
trainer.save_model('models/logion-archaic')
tokenizer.save_pretrained('models/logion-archaic')
