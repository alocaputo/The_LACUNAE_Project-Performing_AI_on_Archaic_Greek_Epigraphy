...
training_args = Seq2SeqTrainingArguments(
    output_dir="models/greta-archaic",
    ...
    logging_dir='./logs/greta',
    run_name="greta-iphi-archaic",
...
trainer.train()
trainer.save_model('models/greta-archaic')
tokenizer.save_pretrained('models/greta-archaic')
